...
from demos.travel_planner.main import router as travel_planner_router
...
async def lifespan(app: FastAPI):
    ...
    app_state["demos"] = ["bedtime-story-generator", "website-rag", "document-qa-chatbot", "cv-analyzer", "travel-planner"]
    yield
    # Shutdown
