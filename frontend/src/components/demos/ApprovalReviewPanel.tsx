      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3 pt-4 border-t border-gray-200">
          ...
          <div className="space-y-3">
            <div>
              <label htmlFor="review_notes" className="block text-sm font-semibold text-gray-700 mb-2">
                Your Decision & Feedback * <span className="text-gray-500 font-normal text-xs">(Required)</span>
              </label>
              <textarea
                id="review_notes"
                value={reviewNotes}
                onChange={(e) => onReviewNotesChange(e.target.value)}
                placeholder="Please provide your decision reasoning and feedback. This is required for all approvals/rejections."
                className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-gray-900 placeholder-gray-400 bg-white min-h-[100px] resize-y"
                required
              />
              <p className="mt-1 text-xs text-gray-500">
                Human escalation requires your feedback. Please explain your decision reasoning.
              </p>
            </div>
