          ...
          <div className="flex justify-between items-center h-16 sm:h-18">
            ...
            <div className="hidden lg:flex items-center">
              <Link 
                ...
                className="bg-gradient-to-r from-gray-900 to-gray-800 hover:from-gray-800 hover:to-gray-700 text-white font-semibold py-3 px-6 rounded-lg text-sm transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 inline-block"
            ...
            <div className="lg:hidden">
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-200">
                ...
                <div className="pt-4 border-t border-gray-200">
                  <Link 
                    href="https://learnwithparam.com?utm_source=demos&utm_medium=ai-bootcamp&utm_campaign=demo-site" 
                    className="bg-gradient-to-r from-gray-900 to-gray-800 hover:from-gray-800 hover:to-gray-700 text-white font-semibold py-3 px-6 rounded-lg text-base transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 w-full text-center block"
                    aria-label="Enroll in AI Bootcamp"
                  >
                    Enroll Now
                  </Link>
          ...
          <div className="max-w-4xl mx-auto container-padding">
            <div className="text-center mb-8 sm:mb-12 md:mb-16">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed px-2">
                Hands-on demonstrations from each week of the AI Bootcamp for Software Engineers
              </p>
            </div>
      ...
      <footer className="bg-gray-50 py-8">
        <div className="max-w-4xl mx-auto container-padding text-center">
          <p className="text-gray-600 text-sm">
            © 2025 learnwithparam. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
